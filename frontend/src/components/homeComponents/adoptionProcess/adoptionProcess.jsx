        ...
        <div className="section_container">
          ...
          <div className="card card_left">
            ...
            <div className="card_description">
              ...
              <p>
                ...
                age, health,status and ask all those questions you have so that
                this experiece is sucessful and wonderful.
              </p>
            </div>
          </div>
          ...
          <div className="card card_left">
            ...
            <div className="card_description">
              ...
              <p>
                After filling the information take your friendly companion to
                your home who will always acompany you in your journey.
              </p>
            </div>
          </div>
        </div>

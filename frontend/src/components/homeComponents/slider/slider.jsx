  ...
  useEffect(() => {
    ...
    imageButtons.forEach((button, index) => {
      button.addEventListener("click", () => {
        ...
        sliderCards[
          (index - 1 + sliderCards.length) % sliderCards.length
        ].classList.add("left");
        ...
        <div className="card-slider-container">
          <div className="slider-card left">
            <p>
              ...
              Voluptates molestias ipsum ducimus accusantium dolor velit dolore
              odit, voluptatibus rem ad ipsam molestiae expedita. Ipsum, sequi
              voluptatibus sint sapiente ea enim. Nostrum commodi tempore
              provident officia dolorum deserunt neque obcaecati excepturi.
            </p>

            <div className="person-info">
              <img
                className="image-small-device"
                src="https://lh4.googleusercontent.com/proxy/SYiZj04ZhL7Itm1TcbL3RiRuP1FNPPb2RN3lQqF2hAGmkKNMZN8M19sv1D6DJvYSOIykrXrHXYoj53rCWMkzSVRv9tOt6Mmz2D5TgO1APx2x0oCGRXKV039N6ejXm78AIw"
              />
              <div>
                <h1>Barun Pahari</h1>
                <p className="slider-card-label">LABEL</p>
          ...
          <div className="image-buttons">
            ...
            <img
              className="image-button"
              src="https://img.freepik.com/premium-vector/young-girl-anime-style-character-vector-illustration-design-manga-anime-girl-hair-faces-cartoon_147933-1139.jpg?w=360"
            />
          </div>
        </div>
      </div>
